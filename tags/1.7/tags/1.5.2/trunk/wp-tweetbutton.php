...
<p>If you have any questions, suggestions or bug reports regarding the plugin then drop me a comment at <a href="http://coderplus.com/2010/08/twitter-tweet-button-plugin-for-wordpress/">my blog post</a></p>
</script>
</td>
</tr>
...
$tweet_text_link='http://twitter.com/share?text='.urlencode($text).'&url='.urlencode($link).'&related='.urlencode($related);
if($twitterhandle!="") $tweet_text_link=$tweet_text_link.'&via='.urlencode($twitterhandle);
return $tweet_text_link;
}
}
