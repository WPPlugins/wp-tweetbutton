...
{$tweetbutton_twitter= get_user_meta($user->ID,'tweetbutton_twitter');
 $tweetbutton_twitter_desc= get_user_meta($user->ID,'tweetbutton_twitter_desc');
} 
else
{
...
{if (function_exists('get_user_meta'))
$twitterhandle=get_user_meta($post->post_author,'tweetbutton_twitter');
else $twitterhandle=get_usermeta($post->post_author,'tweetbutton_twitter');
}
if($tweetrel=="%post_author%")
{ 
if (function_exists('get_user_meta'))
$tweetrel=get_user_meta($post->post_author,'tweetbutton_twitter');
else
...
{
if (function_exists('get_user_meta'))
$tweetreldesc=get_user_meta($post->post_author,'tweetbutton_twitter_desc');
else
