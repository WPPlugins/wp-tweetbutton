...
function action_show_user_profile($user) {
    ...
    <tr>
        ...
        <td><input type="text" name="tweetbutton_twitter" id="tweetbutton_twitter" value="<?php echo esc_attr(get_the_author_meta('tweetbutton_twitter', $user->ID) ); ?>" />
        ...
        <td><input type="text" name="tweetbutton_twitter_desc" id="tweetbutton_twitter_desc" value="<?php echo esc_attr(get_the_author_meta('tweetbutton_twitter_desc', $user->ID) ); ?>" />
...
$twitterhandle=get_the_author_meta('tweetbutton_twitter', $post->post_author);

if($tweetrel=="%post_author%") 
$tweetrel=get_the_author_meta('tweetbutton_twitter', $post->post_author);

if($tweetreldesc=="%post_author_bio%")
$tweetreldesc=get_the_author_meta('tweetbutton_twitter_desc', $post->post_author);
